...
function Modifier_export(props) {
    ...
    const postData = (dataToSubmit) => {
        fetch("https://127.0.0.1:8089/api/export/"+props.data.id, {
          method: "put",
          headers: {
    ...
    const [data, setData] = useState({
            range_5: exportData.range_5,
            range_10: exportData.range_10,
            range_15: exportData.range_15,
            range_20: exportData.range_20,
            range_25: exportData.range_25,
            range_30: exportData.range_30,
            clientId: exportData.client.id,
            date: "",
      });
...
export default Modifier_export