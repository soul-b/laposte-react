        ...
        <div className="container">
            ...
            <div className="sidebar">
                <div style={{top: `${highlightTopPosition}px`}}
                     className={`sidebar__highlight ${startAnimate && 'sidebar__highlight__animate'}`}></div>
                ...
                <Link className={currCount === 0 && 'active'} to="/admin/gestion_clients" onClick={() => onClickTab(0)}>
                    <span className={currCount === 0 && 'text-active'}><i
                        className="fas fa-arrow-right"></i> Clients</span>
                </Link>
                <Link className={currCount === 1 && 'active'} to="/admin/gestion_employes"
                      onClick={() => onClickTab(1)}>
                    <span className={currCount === 1 && 'text-active'}><i
                        className="fas fa-arrow-right"></i> Employés</span>
                </Link>
                ...
                <Link className={currCount === 2 && 'active'} to="/admin/compte" onClick={() => onClickTab(3)}>
                    <span className={currCount === 2 && 'text-active'}><i
                        className="fas fa-arrow-right"></i> Compte</span>
                </Link>
                <Link className={currCount === 3 && 'active'} to="/admin/Deconnexion" onClick={() => onClickTab(4)}>
